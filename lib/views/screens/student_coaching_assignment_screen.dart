...
class StudentCoachingAssignmentScreen extends ConsumerStatefulWidget {
  const StudentCoachingAssignmentScreen({super.key});

  @override
  ConsumerState<StudentCoachingAssignmentScreen> createState() =>
      _StudentCoachingAssignmentScreenState();
}

class _StudentCoachingAssignmentScreenState
    extends ConsumerState<StudentCoachingAssignmentScreen> {
