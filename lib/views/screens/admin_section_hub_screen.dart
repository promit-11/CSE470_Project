...
import 'package:cse470_app/views/screens/admin_exam_list_screen.dart';
import 'package:cse470_app/views/widgets/ui_components.dart';
import 'package:flutter/material.dart';
import 'package:flutter_riverpod/flutter_riverpod.dart';

class AdminSectionHubScreen extends ConsumerWidget {
  const AdminSectionHubScreen({super.key});
                    ...
                    onPressed: () {
                      Navigator.of(context).push(
                        MaterialPageRoute<void>(
                          builder: (_) => AdminExamListScreen(section: section),
                        ),
                      );
                    },
