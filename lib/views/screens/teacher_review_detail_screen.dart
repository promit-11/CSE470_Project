...
class TeacherReviewDetailScreen extends ConsumerStatefulWidget {
  const TeacherReviewDetailScreen({
    super.key,
  ...
  @override
  ConsumerState<TeacherReviewDetailScreen> createState() =>
      _TeacherReviewDetailScreenState();
}

class _TeacherReviewDetailScreenState
    extends ConsumerState<TeacherReviewDetailScreen> {
                ...
                child: Form(
                  ...
                  child: Column(
                    children: <Widget>[
                      SectionCard(
                        title:
                            '${_request!.section.toUpperCase()} Review • ${_request!.status}',
          ...
          if (recording == null || recording.publicUrl.isEmpty)
            ...
            Card(
              ...
              child: ListTile(
                ...
                subtitle: Text(
                  'Playback URL available${recording.sizeBytes > 0 ? ' • ${recording.sizeBytes} bytes' : ''}',
                ),
                trailing: IconButton(
            ...
            ...sectionContext.questions
                ...
                .map(
                  (q) => ListTile(
                    ...
                    subtitle: Text(
                      '${q.questionType} • ${q.category} • ${q.difficulty}',
                    ),
                  ),
                ),
          ],
