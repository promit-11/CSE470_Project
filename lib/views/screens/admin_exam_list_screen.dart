...
class AdminExamListScreen extends ConsumerStatefulWidget {
  const AdminExamListScreen({super.key, this.section});

  final AdminDashboardSection? section;

  @override
  ConsumerState<AdminExamListScreen> createState() =>
      _AdminExamListScreenState();
}

class _AdminExamListScreenState extends ConsumerState<AdminExamListScreen> {
            ...
            if (state.exams.isEmpty)
              ...
              ...state.exams.take(8).map((exam) {
                ...
                return ListTile(
                  ...
                  contentPadding: EdgeInsets.zero,
                  title: Text(title),
                  subtitle: Text('Type: ${exam['type'] ?? ''} • APP-OWNED'),
                  trailing: Wrap(
                    spacing: 4,
                    runSpacing: 4,
            ...
            if (state.questions.isEmpty)
              ...
              ...state.questions.take(8).map((question) {
                ...
                return ListTile(
                  ...
                  subtitle: Text(
                    '$section • $examLabel${_isListeningSection(section) ? ' • $audioState' : ''}',
                  ),
                  trailing: Wrap(
                    spacing: 4,
                    children: <Widget>[
            ...
            if (state.templates.isEmpty)
              ...
              ...state.templates.take(8).map((template) {
                ...
                return ListTile(
                  ...
                  subtitle: Text(
                    'Type: ${template['examType'] ?? ''} • $examLabel',
                  ),
                  trailing: Switch(
                    value: active,
