...
class AdminOverviewView extends ConsumerStatefulWidget {
  const AdminOverviewView({super.key, this.section});
        ...
        child: Column(
          ...
          children: <Widget>[
            Container(
              ...
              child: const Text(
                'Prototype: Database manager is a powerful tool. Use with caution in demos.',
                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                          Container(
                            ...
                            child: const Text(
                              'Prototype: Payouts may be unavailable in this deployment.',
                            ),
                          ),
                          const SizedBox(height: 8),
                          Text(
